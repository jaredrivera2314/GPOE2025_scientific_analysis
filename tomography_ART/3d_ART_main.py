...
def reconstruct(camera_images, ansatz):
    volume = ansatz
...
def visualize_volume(volume, camera_positions,sphere_radius,sphere_height):
...
if __name__ == "__main__":
    ...
    if np.size(images)>0:
        ...
        volume = reconstruct(images,v0)
        # For debugging, show projected images alongside their partner real image
        visualize_volume(volume, camera_positions,sphere_radius, sphere_height)
    else:
